The project replicates a portfolio screen of a stock broker app displaying user's holdings from local DB, local DB is populated from an random data API.
